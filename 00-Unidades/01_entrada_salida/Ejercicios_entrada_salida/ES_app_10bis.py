...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        importe_actualizado= importe - (importe * porcentaje) 
        alert(title="Descuento", message="Su importe actualizado, con un descuento del {0} % es: ${1}".format(descuento, round(importe_actualizado,2)))
